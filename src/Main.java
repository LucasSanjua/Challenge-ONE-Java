...
public class Main {
    public static void main(String[] args) {
            ...
            String cantidad;
            do{
                String operacion =  (JOptionPane.showInputDialog(null,"Seleccione una operacion a realizar","Operacion",JOptionPane.PLAIN_MESSAGE,null,new Object[]{"Seleccionar","Convertir de Peso Argentino a Dolar","Convertir de Peso Argentino a Euro","Convertir de Peso Argentino a Libras","Convertir de Peso Argentino a Yen","Convertir de Peso Argentino a Won Coreano","Convertir de Dolar a Peso Argentino","Convertir de Euro a Peso Argentino","Convertir de Libras a Peso Argentino","Convertir de Yen a Peso Argentino","Convertir de Won Coreano a Peso Argentino"},"Selecciona")).toString();
